...
typedef SearchAnchorChildBuilder =
    Widget Function(BuildContext context, MySearchController controller);
...
class _MySearchAnchorState extends State<MySearchAnchor> {
  ...
  MySearchController get _searchController =>
      widget.searchController ??
      (_internalSearchController ??= MySearchController());
