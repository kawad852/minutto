class GooglePlaceDetailsModel {
  ...
  GooglePlaceDetailsModel({this.result, this.status});

  GooglePlaceDetailsModel copyWith({ResultModel? result, String? status}) =>
...
class ResultModel {
  ...
  ResultModel({this.addressComponents, this.geometry});
